package org.learn.boot.demo.config;

import org.learn.boot.demo.compoent.MyLocalResolver;
 ...
 * @Description: 测试使用相应的注解来接管springmvc，而不使用自动配置
 * @Author: lin
 * @Date: 2019/5/22 21:13
 * History:
 * @<version> 1.0
 *
 * @EnableWebMvc 这个注解的意思 就是接管SpringMvc的功能，
 * 如果使用了 那么SpringBoot的指自动配置就会失效，例如静态资源就不能直接访问
 *
 */
